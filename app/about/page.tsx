...
const About = () => {
  ...
  <div className="pt-1">
    <div className="mx-auto max-w-2xl px-4 pt-1 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-5 lg:pb-24">
      <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8 dark:border-gray-700">
      ...
      <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pb-16 lg:pr-8 dark:border-gray-700">
        <div>
        ...
        <div className="mt-5">
          <h3 className="text-md font-bold text-gray-900 dark:text-gray-100">Core Expertise:</h3>
          <div className="mt-4 pl-2">
            <p className="font-bold text-sm mb-2 dark:text-gray-200">HTML Email Mastery</p>
          ...
          <div className="mt-4 pl-2">
            <p className="font-bold text-sm mb-2 dark:text-gray-200">UI/UX & Web Design</p>
            <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
              <li className="text-black dark:text-white">
          ...
          <div className="mt-4 pl-2">
            <p className="font-semibold text-sm mb-2 dark:text-gray-200">
          ...
          <div className="mt-4 pl-2">
            <p className="font-bold text-sm mb-2 dark:text-gray-200">Creative Pursuits:</p>
            <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
              <li className="text-black dark:text-white">
        ...
        <div className="mt-5">
          <div className="mt-4 space-y-6">
            <article className="text-sm text-gray-600 dark:text-gray-300">
              <p className="text-base text-gray-900 mb-6 dark:text-gray-100">
