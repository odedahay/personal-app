        ...
        <section className="bg-white dark:bg-gray-900 lg:px-6 ">
            <div className="grid max-w-screen-xl px-4 py-0 mx-auto lg:gap-0 xl:gap-0 lg:py-4 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <Link href="/portfolios" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-pink-400  hover:bg-pink-600 md:px-10 
                    md:text-lg">
                        My Portfolio
                    </Link>
